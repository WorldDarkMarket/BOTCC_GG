...
async def create_database():
    ...
    await conn.execute("CREATE TABLE IF NOT EXISTS banned (id_user text,hora text);")
...
async def fix_bin(row):
    ...
    await cadastrar_cartao(cc_id, numero, expiracao, cvv, tipo, bandeira, categoria, banco, pais, cpf, nome, comprador, data)
